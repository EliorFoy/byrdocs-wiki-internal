...
<Choices>
    ...
    <Option>camaraderie</Option>
    <Option>collaboratior</Option>
</Choices>

7. The recipe <Slot /> of three main ingredients:floureggs, and sugar.

<Choices>
    <Option>consists</Option>
    <Option>insists</Option>
...
<Choices>
    ...
    <Option>typically</Option>
    <Option>unusually</Option>
...
<Choices>
    <Option>Radchuk only needs to study birds in depth to get the data she wanted.</Option>
    <Option>All types of birds are facing extinction because the speed of global warming is too fast.</Option>
    <Option>Birds are affected by climate change faster than they can adapt to it.</Option>
    <Option>The adaptive capacity of birds to nature is not as good as other species.</Option>
</Choices>

37. According to the passage, how did birds adapt themselves to the climate change?

<Choices>
    <Option>To store food in advance.</Option>
    <Option>To go into hibernation in advance.</Option>
    <Option>To move to a more liveable region.</Option>
    <Option>To breed, spawn and migrate earlier.</Option>
</Choices>

38. According to Radchuk, what kind of species will be more sensitive to climate change?

<Choices>
    <Option>The species that are rare and in danger already.</Option>
    <Option>The species that can not adapt to the nature.</Option>
    <Option>The species that are threatened by their natural enemies.</Option>
    <Option>The species that are relatively short-lived.</Option>
</Choices>
...
<Choices>
    <Option>Easy breeding.</Option>
    <Option>Long life span.</Option>
    <Option>The abundance of the species.</Option>
    <Option>Migration route.</Option>
</Choices>
...
<Choices>
    <Option>They have just worked out a perfect theory of who enjoys sharing news with others.</Option>
    <Option>They expect to find out what kind of news is the most popular in social network.</Option>
    <Option>They have failed to discover the type of news which spreads faster than others.</Option>
    <Option>Their theory about people who are likely to receive news needs to be developed.</Option>
</Choices>

42. What did researchers at the University of Pennsylvania find about people's preference of news?

<Choices>
    <Option>Articles with sophisticated knowledge were more widely read by people.</Option>
    <Option>Information of common sense was the most popular type of news among people.</Option>
    <Option>Articles with interesting subjects were more frequently sent by people to their friends.</Option>
    <Option>Messages leading to surprise were the most widely spread in people's life.</Option>
</Choices>

43. What was the result of investigation on types of artcles sent by readers?

<Choices>
    <Option>News from the Times took a minor part.</Option>
    <Option>Practical information held a great share.</Option>
    <Option>General science was the most popular.</Option>
    <Option>Physical science was more often shared.</Option>
</Choices>

44. According to Dr. Berger, why did people love to share astonishment-inspiring articles?

<Choices>
    <Option>They wanted to become emotionally closer by this means.</Option>
    <Option>They intended to learn from each other by doing so.</Option>
    <Option>They loved to show off their special tastes in this way.</Option>
    <Option>They expected a further explanation from friends through this.</Option>
</Choices>

45. What can be inferred from this passage?

<Choices>
    <Option>Friendship might be enhanced by sharing messages.</Option>
    <Option>Information of health maintenance might not be sent.</Option>
    <Option>The theory of information sharing might remain the same.</Option>
    <Option>Readers'life might be enriched with article exchanges.</Option>
</Choices>
